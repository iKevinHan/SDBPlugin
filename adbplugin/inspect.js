...
var tizen_devices = new Array();
tizen_devices[0] = {
  adbConnected:true,
  adbModel:"Android SDK built for x86",
  adbSerial: "emulator-5554",
  browsers: null
};
tizen_devices[0].browsers = new Array();
tizen_devices[0].browsers[0] = {id:"device:emulator-5554"};

function checkDevices() {
  var plugin = document.getElementById('adb-plugin');
  alert(plugin.devices());
  populateTargets('adb', tizen_devices);
}
setInterval(checkDevices, 6000);
